...
<div class="menu-buttons">
    <div class="desktop-menu">
        ...
        <button class="menu-button desktop-menu-item" data-modulo="mods/mod_sesion/mod_login.php">Iniciar Sesión</button>
    ...
    <div class="mobile-menu">
        ...
        <div class="mobile-menu-content" id="mobile-menu-content">
            ...
            <button class="menu-button mobile-menu-item" data-modulo="mods/mod_sesion/mod_login.php">Iniciar Sesión</button>
