<?php
session_start();
require_once '../../connection/connection.php'; // Ajusta la ruta según tu estructura
...
try {
    $stmt = $pdo->prepare("
        SELECT 
            nombre_usuario, correo, telefono, plataforma, generacion, pos1, pos2, pos3, imagen_perfil 
        FROM 
            usuarios 
        WHERE 
            id = :user_id
